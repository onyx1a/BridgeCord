...
PYBIND11_MODULE(discordBridge, m) {
    ...
    py::class_<Instance>(m, "Instance")
            ...
            .def("current_user_update_connect", &Instance::OnCurrentUserUpdateConnect, R"pbdoc(
:return: A unique token that is used if you need to disconnect callback
    )pbdoc")
            .def("current_user_update_disconnect", &Instance::OnCurrentUserUpdateDisconnect, R"pbdoc(
